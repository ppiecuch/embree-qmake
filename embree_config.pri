...
CONFIG += embree_ignore_invalid_rays # Make code robust agains invalid rays.
...
CONFIG += embree_geom_line      # Enables support for line geometries.
...
embree_ignore_invalid_rays: DEFINES += EMBREE_IGNORE_INVALID_RAYS
embree_backface_culling: DEFINES += EMBREE_BACKFACE_CULLING
embree_filter_function: DEFINES += EMBREE_FILTER_FUNCTION
embree_geom_triangle: DEFINES += EMBREE_GEOMETRY_TRIANGLE
embree_geom_quad: DEFINES += EMBREE_GEOMETRY_QUAD
embree_geom_curve: DEFINES += EMBREE_GEOMETRY_CURVE
embree_geom_line: DEFINES += EMBREE_GEOMETRY_LINE
...
embree_geom_instance: DEFINES += EMBREE_GEOMETRY_INSTANCE
